...
<%@page import="com.example.lab7_20182048.Beans.Job" %>
<%@page import="com.example.lab7_20182048.Beans.Department" %>
<jsp:useBean id="listaTrabajos" type="java.util.ArrayList<com.example.lab7_20182048.Beans.Job>" scope="request" />
<jsp:useBean id="listaJefes" type="java.util.ArrayList<com.example.lab7_20182048.Beans.Employee>" scope="request" />
<jsp:useBean id="listaDepartamentos" type="java.util.ArrayList<com.example.lab7_20182048.Beans.Department>" scope="request" />
<jsp:useBean id="empleado" type="com.example.lab7_20182048.Beans.Employee" scope="request"/>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div class='container mb-4'>
            <div class="row justify-content-center">
                ...
                <hr>
                <form method="POST" action="home?action=actualizar" class="col-md-6 col-lg-6">
                    ...
                    <a href="<%= request.getContextPath()%>/home" class="btn btn-danger">Cancelar</a>
